...
var parameterAbi = Nethereum.Generators.Model.Parameter;
...
function generateAllFiles(abi, byteCode, contractName, baseNamespace, serviceNamespace, cqsNamespace, dtoNamespace, basePath, pathSeparator) {
    var contractDes = buildContract(abi);
    var classGenerator = new Nethereum.Generators.ContractProjectGenerator(contractDes, contractName, byteCode, baseNamespace, serviceNamespace, cqsNamespace, dtoNamespace, basePath, pathSeparator);
...
function generateProjectClassLibrary(projectName, basePath) {
    var projectGenerator = new Nethereum.Generators.CsharpLibraryGenerator(projectName);
...
var basePath = "C:\\Users\\juanf\\Documents\\source\\repos\\codeGenNodeTests";
var pathSeparator = "\\";
var projectName = "StandardToken.csproj";
generateProjectClassLibrary(projectName, basePath);
generateAllFiles(abi, contractByteCode, contractName, baseNamespace, serviceNamespace, cqsNamespace, dtoNamespace, basePath, pathSeparator);
console.log("Done");
